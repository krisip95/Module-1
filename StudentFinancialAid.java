...
public class StudentFinancialAid {
	...
	public static void main(String[] args) {
		...
		Student_11[] students = new Student_11[5]; //suzdavame masiv ot u4enitsi
		...
		for(int i = 0; i < 5; i++) {
			...
			sc.nextLine();
			//students[i].name = name; greshno
			//students[i].grade = grade; greshno
			students[i] = new Student_11( name, grade); //suzdavame obekt u4enik
		}
